...
async def _generate_edge_tts(text: str, output_path: str, tts_config: Dict[str, Any]) -> str:
    ...
    # Multilingual script adaptation: If text contains Devanagari Hindi characters,
    # route to hi-IN-MadhurNeural to preserve natural native Hindi pronunciation.
    if re.search(r'[\u0900-\u097F]', text) and voice == DEFAULT_EDGE_VOICE:
