...
export default function App() {
  ...
  const [jarvisHudActive, setJarvisHudActive] = useState(true);
  ...
  return (
    <ProfileProvider>
      ...
      {themeName === "jarvis" && !jarvisHudActive && (
        <button
          onClick={() => setJarvisHudActive(true)}
          className="fixed bottom-4 right-4 z-50 flex items-center gap-2 rounded-full border border-[#00E5FF]/60 bg-[#0A1628]/90 px-3.5 py-1.5 font-['Rajdhani',sans-serif] text-xs font-bold text-[#00E5FF] shadow-[0_0_20px_rgba(0,229,255,0.4)] backdrop-blur-md transition hover:scale-105 hover:bg-[#00E5FF]/20"
        >
