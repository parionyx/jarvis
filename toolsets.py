...
TOOLSETS = {
    ...
    "desktop_ui": {
        "description": "Desktop GUI affordances \u2014 in-app terminal/browser panes, pane focus, reactions, interactive buttons/forms (GUI sessions only)",
        "tools": [
            ...
            "setup_mcp", "tour",
            "show_buttons", "show_form",
            "artifact_studio", "artifact_read", "artifact_apply", "artifact_simulate_request",
        ],
        "includes": []
    },
