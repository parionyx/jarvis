...
contextBridge.exposeInMainWorld('hermesDesktop', {
  getSystemTelemetry: () => ipcRenderer.invoke('hermes:system:telemetry'),
  getLiveKitToken: () => ipcRenderer.invoke('hermes:livekit:token'),
  ...
  captureScreen: (options?: { screenIndex?: number }) => ipcRenderer.invoke('hermes:screen:capture', options),
  computer: {
    execute: (payload: any) => ipcRenderer.invoke('hermes:computer:execute', payload),
    abort: () => ipcRenderer.invoke('hermes:computer:abort')
  },
  getPathForFile: file => {
    try {
