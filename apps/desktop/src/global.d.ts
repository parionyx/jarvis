...
declare global {
  interface Window {
    hermesDesktop: {
      getLiveKitToken?: () => Promise<{ url: null | string; token: null | string; error?: string }>
      ...
      /** JARVIS Phase 2 screen vision: capture current display and active window metadata */
      captureScreen?: (options?: { screenIndex?: number }) => Promise<{
        activeWindow: { appName?: string; bounds?: unknown; windowTitle?: string } | null
        dataUrl: string
        filePath: string
        height: number
        scale: number
      ...
      /** JARVIS Phase 3 computer control: mouse, keyboard, window, and app automation */
      computer?: {
        execute: (payload: {
          action: string
          amount?: number
          ...
          x?: number
          y?: number
        }) => Promise<{ data?: unknown; error?: string; message?: string; success: boolean }>
