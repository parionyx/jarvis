...
export interface Translations {
  ...
  titlebar: {
    ...
    hideRightRail: string
    showRightRail: string
  ...
  artifactCard: {
    kind: Record<'code' | 'html' | 'react' | 'svg', string>
  ...
  artifactStudio: {
    ...
    status_conceptual: string
    status_geometrically_consistent: string
    status_simulation_tested: string
    status_engineering_validated: string
    status_manufacturing_ready: string
    validation_unverified: string
