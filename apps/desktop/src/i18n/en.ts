...
export const en: Translations = {
  ...
  boot: {
    ready: 'J.A.R.V.I.S. is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading J.A.R.V.I.S. settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Hermes backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting J.A.R.V.I.S.…'
    },
    errors: {
      backgroundExited: 'J.A.R.V.I.S. background process exited.',
      backgroundExitedDuringStartup: 'J.A.R.V.I.S. background process exited during startup.',
    ...
    failure: {
      title: "J.A.R.V.I.S. couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your J.A.R.V.I.S. backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update J.A.R.V.I.S.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try Restarting J.A.R.V.I.S. Desktop.',
    ...
    native: {
      ...
      inputBody: 'J.A.R.V.I.S. is waiting for your response.',
      turnDoneTitle: 'J.A.R.V.I.S. finished',
      turnDoneBody: '',
  ...
  titlebar: {
    ...
    hideRightRail: 'Hide right panel',
    showRightRail: 'Show right panel',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to J.A.R.V.I.S. defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Run in the J.A.R.V.I.S. backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the J.A.R.V.I.S. backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while J.A.R.V.I.S. is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'J.A.R.V.I.S. asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while J.A.R.V.I.S. was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while J.A.R.V.I.S. was in the background.'
        }
      },
      test: 'Send test notification',
      testTitle: 'J.A.R.V.I.S.',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let J.A.R.V.I.S. follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and J.A.R.V.I.S. can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated mascot that floats over the app and reacts to what J.A.R.V.I.S. is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen J.A.R.V.I.S., then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'J.A.R.V.I.S. checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading J.A.R.V.I.S. configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening J.A.R.V.I.S..',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a J.A.R.V.I.S. backend elsewhere. Per-profile overrides below.',
      ...
      localDesc: 'Start a private J.A.R.V.I.S. backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote J.A.R.V.I.S. backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'J.A.R.V.I.S. Cloud',
      cloudDesc: 'Sign in once to J.A.R.V.I.S. Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'J.A.R.V.I.S. Cloud',
      cloudSignIn: 'Sign in to J.A.R.V.I.S. Cloud',
      cloudSignedIn: 'Signed in to J.A.R.V.I.S. Cloud',
      cloudNeedsSignIn: 'Sign in to J.A.R.V.I.S. Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your J.A.R.V.I.S. Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'J.A.R.V.I.S. Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of J.A.R.V.I.S. Cloud',
      cloudSignedOutMessage: 'Cleared the J.A.R.V.I.S. Cloud session.',
      ...
      restartingMessage: 'J.A.R.V.I.S. will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · J.A.R.V.I.S. ${version}` : ''}`,
      ...
      sshDesc:
        'J.A.R.V.I.S. is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'J.A.R.V.I.S. path (optional)',
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — J.A.R.V.I.S. runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'J.A.R.V.I.S. is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the J.A.R.V.I.S. path.',
      sshErrPlatform:
        'Unsupported remote platform. J.A.R.V.I.S. SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update J.A.R.V.I.S. on the remote host before connecting.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. J.A.R.V.I.S. runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point J.A.R.V.I.S. at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As J.A.R.V.I.S. builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart J.A.R.V.I.S. to use pets - the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update J.A.R.V.I.S. to generate pets.',
      backgroundHint: 'You can close this - J.A.R.V.I.S. will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure J.A.R.V.I.S. desktop' },
    ...
    hermesActiveSessions: (version, count) => `J.A.R.V.I.S. ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent J.A.R.V.I.S. environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'J.A.R.V.I.S. did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. J.A.R.V.I.S. will run it and deliver results to the destination you pick.',
  ...
  artifactCard: {
    kind: { code: 'Code', html: 'Interactive page', react: 'React component', svg: 'Graphic' },
  ...
  artifactStudio: {
    studioTitle: 'Artifact Studio',
    viewportPlaceholder: '3D VIEWPORT',

    
    viewportLoading: 'Loading 3D scene…',
    viewportFailed: '3D engine failed to load. Restart the studio.',

    chatTitle: 'JARVIS · session',
    chatYou: 'You',
    chatJarvis: 'JARVIS',
    chatEmpty: 'Ask JARVIS below — replies appear here.',
    simDisclaimer: 'rule-of-thumb estimate, not a solver result',
    simSolverPending: 'Full electrical/thermal simulation ships with Phase 3.',
    paletteTitle: 'Add component',
    paletteAdd: 'Add',
    deleteSelected: 'Delete selected',
    renameLabel: 'Rename component',
    wireStart: 'Start wire from this port',
    customPart: 'Custom part…',
    customName: 'Part name',
    customNamePlaceholder: 'e.g. Laser module',
    customDims: 'Dimensions',
    customColor: 'Color',
    simPlay: 'Play',
    simPause: 'Pause',
    simStop: 'Stop',
    ...
    teleSoc: 'battery',
    teleThrottle: 'thr',
    launcherTitle: 'projects',
    newProject: 'New project',
    recentProjects: 'recent',
    noRecents: 'No projects yet.',
    tplBlank: 'Blank design',
    tplDrone: 'Quadcopter drone',
    tplArm: 'Robot arm',
    noProjectTitle: 'No artifact open',
    noProjectDesc: 'Ask JARVIS to build something — "mujhe drone banana hai" — or toggle Artifact Studio from the command palette.',
    noProjectHint: 'No project open. Use artifact_studio in chat.',

    askLabel: 'Ask JARVIS',
    askPlaceholder: 'e.g. battery ko center me shift karo',
    askNoProject: 'Open an artifact first',
    send: 'Send',
    modeDesign: 'DESIGN',
    ...
    consoleTitle: 'Console · events',
    consoleEmpty: 'Studio events appear here.',

    conceptualNote: 'conceptual model — not validated',
    unverifiedNote: 'unverified',
    manufacturingReady: 'mfg-ready',
    ...
    provenanceSuffix: '(user-provided)',
    noSelection: 'Select a component in the assembly tree to inspect it.',

    status_conceptual: 'conceptual',
    status_geometrically_consistent: 'geometrically consistent',
    status_simulation_tested: 'simulation tested',
    status_engineering_validated: 'engineering validated',
    status_manufacturing_ready: 'manufacturing ready',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the J.A.R.V.I.S. backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from J.A.R.V.I.S.. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting J.A.R.V.I.S....',
    placeholderReconnecting: 'Reconnecting to J.A.R.V.I.S..',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give J.A.R.V.I.S. a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'J.A.R.V.I.S. will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask J.A.R.V.I.S. to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating J.A.R.V.I.S..',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting J.A.R.V.I.S.…',
    ...
    unsupportedMessage: 'This version of J.A.R.V.I.S. can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of J.A.R.V.I.S. is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected J.A.R.V.I.S. backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed J.A.R.V.I.S. from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'J.A.R.V.I.S. will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the J.A.R.V.I.S. desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The J.A.R.V.I.S. updater takes over in its own window and reopens J.A.R.V.I.S. automatically when it’s done. Please don’t reopen J.A.R.V.I.S. yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. J.A.R.V.I.S. reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then J.A.R.V.I.S. reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'J.A.R.V.I.S. needs a one-time install',
    ...
    setupChoiceTitle: 'Set up J.A.R.V.I.S.',
    setupChoiceDesc:
      'Connect this app to a J.A.R.V.I.S. gateway you already run, or install J.A.R.V.I.S. locally on this computer.',
    connectExistingTitle: 'Connect to existing J.A.R.V.I.S.',
    ...
    installLocalTitle: 'Install J.A.R.V.I.S. locally',
    installLocalDesc: 'Download J.A.R.V.I.S., create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart J.A.R.V.I.S. and try again.',
    remoteSetupTitle: 'Connect to existing J.A.R.V.I.S.',
    remoteSetupDesc: 'Enter your gateway URL. J.A.R.V.I.S. will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the J.A.R.V.I.S. gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/jarvis',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that J.A.R.V.I.S. gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up J.A.R.V.I.S.',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another J.A.R.V.I.S. CLI or desktop instance is running. Stop any running J.A.R.V.I.S. instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The J.A.R.V.I.S. installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with J.A.R.V.I.S. Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'J.A.R.V.I.S. is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting J.A.R.V.I.S..',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run J.A.R.V.I.S.',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point J.A.R.V.I.S. at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — J.A.R.V.I.S. connects automatically',
    ...
    authorizeThere: 'Authorize J.A.R.V.I.S. there.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `J.A.R.V.I.S. Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `J.A.R.V.I.S. Cloud · ${host}`,
  ...
  preview: {
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'J.A.R.V.I.S. is restarting...',
      askRestart: 'Ask J.A.R.V.I.S. to restart the server',
      lookingRestart: taskId => `J.A.R.V.I.S. is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'J.A.R.V.I.S. is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask J.A.R.V.I.S. to open a page.',
      finishedRestarting: message => `J.A.R.V.I.S. finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'J.A.R.V.I.S. could not restart the server.',
      stillWorking:
        'J.A.R.V.I.S. is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'J.A.R.V.I.S. is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'J.A.R.V.I.S. gateway is not connected',
  ...
  prompts: {
    ...
    sudoDesc: 'J.A.R.V.I.S. needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'J.A.R.V.I.S. needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart J.A.R.V.I.S. to use Save Image.',
    restartToSaveImages: 'Restart J.A.R.V.I.S. to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `jarvis gateway` running?'
    }
  },
