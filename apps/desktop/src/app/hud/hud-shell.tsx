...
export function HudShell() {
  ...
  return (
    ...
    >
      ...
      {themeName === 'jarvis' && (
        <div aria-hidden className="pointer-events-none absolute inset-x-0 top-0 z-10 flex h-5 items-center justify-between border-b border-[#00d4ff]/15 bg-[#00d4ff]/[0.03] px-2.5">
          <div className="flex items-center gap-1.5">
            <span className="size-1 animate-pulse rounded-full bg-[#ffb86c] shadow-[0_0_4px_#ffb86c]" />
            <span className="font-mono text-[8px] font-bold tracking-[0.18em] text-[#00d4ff]">JARVIS HUD</span>
          </div>
          <span className="font-mono text-[8px] tracking-widest text-white/25">SYS ONLINE · VOICE READY</span>
        </div>
      )}
