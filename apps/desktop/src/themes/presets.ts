...
/**
 * JARVIS — cinematic AI operating system skin.
 *
 * Color language: deep black-blue base, restrained cyan illumination as emitted
 * light (not neon fill), glass/metal elevated surfaces, precise technical
 * typography. Reference: J.A.R.V.I.S. from high-end science-fiction films.
 *
 * There is no light variant — JARVIS is always dark.
 */
export const jarvisTheme: DesktopTheme = {
  name: 'jarvis',
  label: 'J.A.R.V.I.S.',
  description: 'Cinematic AI operating system — dark glass and cyan light',
  colors: {
    // These are also the dark colors — jarvis has no bright mode.
    background: '#03070D',
    foreground: '#E8FBFF',
    card: '#07111C',
    cardForeground: '#E8FBFF',
    muted: '#0B1A28',
    mutedForeground: '#7E9AA5',
    popover: '#081420',
    popoverForeground: '#E8FBFF',
    primary: '#00E5FF',
    primaryForeground: '#03070D',
    secondary: '#0A1E2E',
    secondaryForeground: '#B0D8E0',
    accent: '#0D2033',
    accentForeground: '#47F3FF',
    border: 'transparent',
    input: 'rgba(0, 229, 255, 0.10)',
    ring: '#00E5FF',
    midground: '#00E5FF',
    composerRing: '#00E5FF',
    destructive: '#FF5F6D',
    destructiveForeground: '#E8FBFF',
    sidebarBackground: '#020609',
    sidebarBorder: 'transparent',
    userBubble: '#091828',
    userBubbleBorder: 'rgba(0, 229, 255, 0.20)'
  },
  typography: {
    fontSans:
      '"Inter", "Segoe WPC", "Segoe UI", -apple-system, BlinkMacSystemFont, system-ui, sans-serif, ' +
      EMOJI_FALLBACK,
    fontMono: `"JetBrains Mono", ${SYSTEM_MONO}`,
    fontUrl:
 ...
 *  jarvis is the default for new installations; existing saved preferences
 *  are preserved by the normalizeSkin fallback in context.tsx.
 */
