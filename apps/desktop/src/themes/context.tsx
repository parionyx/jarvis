...
import { BUILTIN_THEME_LIST, DEFAULT_SKIN_NAME, DEFAULT_TYPOGRAPHY, jarvisTheme, nousTheme } from './presets'
...
// JARVIS is always-dark: when the resolved default skin is jarvis and no mode
// is persisted, start in dark mode instead of light.
