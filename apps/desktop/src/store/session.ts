...
export function getRememberedSessionId(_profile: string): null | string {
...
export function rememberedSessionProfile(
  ...
  const match = sessions.find(s => sessionMatchesStoredId(s, sessionId))
...
export function getRememberedRoute(_profile: string): null | string {
  discardLegacyRememberedNavigation()
