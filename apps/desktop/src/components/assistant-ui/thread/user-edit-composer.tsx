...
import { Loader2Icon, StopFilled } from '@/lib/icons'
        ...
        >
          ...
          >
            ...
            <button
              ...
              type="button"
            >
              {submitting ? <StopFilled aria-hidden className="size-3.5 -translate-y-px" /> : <Codicon name="arrow-up" size={USER_ACTION_ICON_SIZE} />}
            </button>
          </div>
        </div>
      </StickyHumanMessageContainer>
