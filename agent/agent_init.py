...
def init_agent(
    ...
    Args:
        ...
        form_callback (callable): Callback function(title, fields, submit_label) -> str for blocking
            structured form input in GUI surfaces. If None, the show_form tool returns an error.
    ...
    agent.form_callback = form_callback
